...
from game_system.weekend import execute_weekend_home_action
...
class Test(TestCase):
    ...
    @patch('game_system.weekend.get_user_choice_weekend_schoolwork', return_value='project')
    @patch('game_system.weekend.weekend_schoolwork')
    ...
    @patch('game_system.weekend.weekend_sleep')
