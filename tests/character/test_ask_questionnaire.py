...
from helper_functions.character import ask_questionnaire


class Test(TestCase):
    @patch('helper_functions.character.input', side_effect=['1', '2', '1', '2'])
    ...
    @patch('helper_functions.character.input', side_effect=['2', '1', '2', '1'])
